...
def main():
    ...
    users = scraper.search_users(location='Beijing', min_followers=500)
...
1. `users.csv`: Contains information about {len(users)} GitHub users in Beijing with over 100 followers
